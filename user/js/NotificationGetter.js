app.factory('NotificationGetter', ['$http', function($http) {
    return {
        ...
        getHistory: function(userId, accessToken, subscriptionId, deliveryTime, channelName, url,
            successFunction, errorFunction) {
            console.log('1deamxwu ---> getting history as UserId: ' + userId + ' SubId: ' + subscriptionId)
            var message = {
                'dataverseName': "channels",
                'userId': userId,
                'accessToken': accessToken,
                ...
                'userSubscriptionId': subscriptionId,
                'channelExecutionTime': deliveryTime,
                'historyTime': "2016-09-25T12:12:12.000Z"
            };
